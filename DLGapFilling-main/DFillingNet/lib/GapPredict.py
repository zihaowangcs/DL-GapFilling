...
arg_parser = argparse.ArgumentParser(description="DGCNet")
...
arg_parser.add_argument('-hu', type=int, nargs=1, default=[256], help="number of hidden units in the LSTM")
arg_parser.add_argument('-ed', type=int, nargs=1, default=[32], help="number of dimensions in base embedding vector")
arg_parser.add_argument('-bs', type=int, nargs=1, default=[64], help="batch sizes")
...
arg_parser.add_argument('-es', type=int, nargs=1, default=[100], help="early stopping patience epochs")
arg_parser.add_argument('-os', type=int, nargs=1, default=[0], help="replicate offset")
arg_parser.add_argument('-bl', type=int, nargs=1, default=[256], help="beam length")
arg_parser.add_argument('-fl', type=int, nargs=1, default=[64], help="cnn filters")
...
import predict_wave_beam_search as wave_beam_search
...
def main(args):
    ...
    for i in range(replicates):
        ...
        train.train_model(output_directory, min_seed_length, ref_file, read_file, epochs, [batch_size], [rnn_dim], [embedding_dim],[cnn_filter], 1, patience, seed_range_upper)

        print("Wave-Beam search prediction")
        wave_beam_search.predict_arbitrary_length(output_directory, gap_id, ref_file, batch_size, embedding_dim, rnn_dim, cnn_filter, prediction_length, beam_length, base_path=output_directory)
