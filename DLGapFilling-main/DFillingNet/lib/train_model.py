...
def train_model(base_directory, min_seed_length, reference, reads, epochs, batch_sizes, rnn_dims, embedding_dims,cnn_filters, replicates, patience, seed_range_upper, log_samples=False):
                ...
                for cnn_filter in cnn_filters:
                    for i in range(replicates):
                        ...
                        model = GapPredictModel(min_seed_length=min_seed_length, stateful=False,
                                                ...
                                                patience=patience, seed_range_upper=seed_range_upper,
